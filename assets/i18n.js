(function () {
  ...
  const dictionaries = {
    ar: {
      ...
      'Loading music...': 'جارٍ تحميل الموسيقى…',
      'Music unavailable. Tap to retry.': 'تعذّر تشغيل الموسيقى. اضغط للمحاولة.',
    ...
    ru: {
      ...
      'Loading music...': 'Загрузка музыки…',
      'Music unavailable. Tap to retry.': 'Не удалось включить музыку. Нажмите ещё раз.',
